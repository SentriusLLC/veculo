 ...
 * similarity computation and memory management for vector search operations.
 */
public class VectorBuffer {
  ...
  /**
   * Loads a vector block into memory, decompressing if necessary. Implements LRU eviction when
