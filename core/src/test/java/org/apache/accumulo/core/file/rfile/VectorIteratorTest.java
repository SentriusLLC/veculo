...
public class VectorIteratorTest {
  ...
  public void testSimilarityResultComparison() {
    ...
    VectorIterator.SimilarityResult result1 = 
        new VectorIterator.SimilarityResult(null, null, 0.8f);
    VectorIterator.SimilarityResult result2 = 
        new VectorIterator.SimilarityResult(null, null, 0.6f);
    VectorIterator.SimilarityResult result3 = 
        new VectorIterator.SimilarityResult(null, null, 0.9f);
