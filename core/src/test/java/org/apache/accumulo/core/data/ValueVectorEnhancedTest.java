...
public class ValueVectorEnhancedTest {
  ...
  public void testCompressedVectorCreation() {
    ...
    Value compressedValue = Value.newCompressedVector(original, VectorCompression.COMPRESSION_QUANTIZED_8BIT);
  ...
  public void testCompressedVectorFallback() {
    ...
    Value uncompressedValue = Value.newCompressedVector(original, VectorCompression.COMPRESSION_NONE);
